...
void ui_Screen1_screen_init(void)
{
    ...
    lv_img_set_src(ui_back, &ui_img_back111_png);
    ...
    lv_obj_set_style_bg_img_src(ui_Button1, &ui_img_1522004715, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui_Button3, &ui_img_start_png, LV_PART_MAIN | LV_STATE_DEFAULT);
